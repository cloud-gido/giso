...
const STR = {
  zh: {
    ...
    'reg.resetCols': '恢复默认',
    'reg.resumeEdit': '返回继续编辑',
    'reg.resumeDismiss': '取消',
    ...
    'view.spaceSettings.desc': '本空间成员与 App Key 绑定；平台账号由平台管理员在「账号管理」中创建',
  ...
  en: {
    ...
    'reg.resumeEdit': 'Resume editing',
    'reg.resumeDismiss': 'Dismiss',
    ...
    'view.spaceSettings.desc': 'Members and App Key bindings for the current space',
