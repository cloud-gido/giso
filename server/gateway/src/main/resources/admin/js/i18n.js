...
const STR = {
  zh: {
    ...
    'reg.density': '密度',
    'reg.densityCompact': '紧凑',
    'reg.densityNormal': '标准',
    'reg.densityComfort': '宽松',
    'reg.tableHint': '拖拽列右边缘调整列宽 · 拖拽 ⠿ 调整列顺序 · 勾选多行可批量操作',
    'reg.resetCols': '恢复默认',
    'reg.refGovernance': '引用治理',
    ...
    'view.spaceSettings.title': '空间设置',
    'view.spaceSettings.desc': '本空间成员（默认只读）与 App Key；平台账号请先在「账号管理」创建',
    'view.users.title': '账号管理',
    'view.users.desc': '创建平台账号并首次授权一个空间；加减成员请到「空间设置」',
    'vp.empty': '在截图上拖拽框选元素',
    'vp.desc': '说明',
    ...
    'copilot.flutterChecklist': 'Flutter 接入清单',
    'top.platform': '平台',
    'top.more': '更多',
    'top.space': '空间',
    'top.logout': '退出登录',
    ...
    'password.saved': '密码已更新，请重新登录',
    'password.failed': '修改失败',
    'password.reset': '重置密码',
    'password.resetPrompt': '为账号 {user} 设置新密码（至少 6 位）',
    'password.resetOk': '已重置 {user} 的密码',
    'space.pick': '选择工作空间',
    ...
    'settings.prefsTitle': '界面偏好',
    'settings.language': '界面语言',
    'settings.displayHint': '注册表可在页面内调整表格密度；整页缩放请使用浏览器 ⌘/Ctrl + +/−。',
    'nav.settings': '系统设置',
  ...
  en: {
    ...
    'reg.density': 'Density',
    'reg.densityCompact': 'Compact',
    'reg.densityNormal': 'Standard',
    'reg.densityComfort': 'Comfort',
    'reg.tableHint': 'Drag column edge to resize · drag ⠿ to reorder · select rows for batch ops',
    'reg.resetCols': 'Reset layout',
    'reg.refGovernance': 'Reference governance',
    ...
    'view.spaces.desc': 'Members and App Key bindings; platform admins can create spaces',
    'view.spaceSettings.title': 'Space Settings',
    'view.spaceSettings.desc': 'Members (default viewer) and App Keys; create accounts under Accounts first',
    'view.users.title': 'Accounts',
    'view.users.desc': 'Create platform accounts with one initial space; manage membership in Space Settings',
    ...
    'copilot.flutterChecklist': 'Flutter checklist',
    ...
    'password.hint': 'You will need to sign in again after saving.',
    ...
    'password.saved': 'Password updated — please sign in again',
    'password.failed': 'Could not change password',
    'password.reset': 'Reset password',
    'password.resetPrompt': 'Set a new password for {user} (min 6 chars)',
    'password.resetOk': 'Password reset for {user}',
    ...
    'settings.prefsTitle': 'Display',
    'settings.language': 'Language',
    'settings.displayHint': 'Adjust table density on the Registry page; use browser ⌘/Ctrl + +/− for page zoom.',
